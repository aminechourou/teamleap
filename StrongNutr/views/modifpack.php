     ...
     <div id="content">
       ...
       <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Pack</h1>
...
<div class="container-fluid">
	 ...
	 <input type="submit" name="modifier" value="Modifier une Pack"  class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" onclick="verifForm()" >
