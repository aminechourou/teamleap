              ...
              <div class="card shadow mb-4">
				...
				<table>
							<tr> 
								...
								<td><a href="promo.html" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-circle"></i> </i>  Ajouter  Promo</a>
			
		  <a href="modifpromo.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-edit"></i> </i> Modifier Promos</a>
				   <a href="supprimer_prom.html" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-trash-alt"></i> </i>Supprimer  Promos </a>
					</td> 		
				  </tr> 
							<tr> 
						</tr>
