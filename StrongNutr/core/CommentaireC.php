...

{
	...
	$ins = $bdd->prepare('INSERT INTO commentaire (reference,user, commentaire, date) VALUES (?,?,?,NOW())');
	...
	function affichercom(){
		...
		$sql="SElECT * From commentaire where reference=$reference order by id DESC";
