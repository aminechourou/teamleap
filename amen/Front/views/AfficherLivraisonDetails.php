...
$listeLivraisons=$livraison1C->afficherLivraisons($_GET['codeC']);
...
foreach($listeLivraisons as $row){
  ...
  <p>ID de livraison: <?PHP echo $row['ID']; ?></p><br>
  <p>Transporteur: <?PHP echo $row['TRANSPORTEUR']; ?></p><br>
  <p>Destination de la livraison: <?PHP echo $row['DESTINATION']; ?></p><br>
  <p>Adresse de la livraison: <?PHP echo $row['ADRESSE']; ?></p><br>
  <p>Delais de la livraison: <?PHP echo $row['DELAIS']; ?> jour(s)</p><br>
  <p>Code de la commande: <?PHP echo $row['CODE_COMMANDE']; ?></p><br>
  <p>Frais de la livraison: <?PHP echo $row['FRAIS']; ?></p><br>

	<button class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer"><a href="ModifierLivraisonDetails.php?id=<?PHP echo $row['ID']; ?>">
