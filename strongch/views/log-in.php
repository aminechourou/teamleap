...
$redirectURL = "http://localhost/StrongWeb/views/fb-callback.php";
$permissions = ['email'];
...
<body class="animsition">
		...
		<div class="container">
		  <div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form name="f" onSubmit="return verifForm2(this)" method="POST" action="connexion.php">
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							Se Connecter
						</h4>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="mail" placeholder="Votre adresse e-mail" onblur="verifMail(this)"  id="mail">
							<img class="how-pos4 pointer-none" src="images/icons/icon-email.png" alt="ICON">
						</div>

						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" name="mdp" placeholder="Votre mot de passe" onblur="verifPrenom(this)" id="mdp">
							<img class="how-pos4 pointer-none" src="images/icons/icon-pass.png" alt="ICON">
						</div>
						<input type="submit" value="Connexion"  class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
						<div class="bor8 m-b-20 how-pos4-parent">
						<input type="button" onclick="window.location ='<?php echo $loginURL?>'" value="Se connecter avec Facebook" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
					   	</div>
					    </form>
					    <div>
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form name="f1" method="GET" action="ajouterclient.php" onsubmit="return verifForm(this)">
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							S'inscrire
						</h4>
	...
	<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="user" placeholder="Pseudo" onblur="verifPrenom(this)" />
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="telephone" placeholder="telephone" maxlength="8" onblur="verifCin(this)" >
							
						</div>
						
                        <div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="mail" placeholder="Adresse e-mail" onblur="verifMail(this)" >
							
						</div>
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" name="mdp" placeholder="Mot de passe" onblur="verifPrenom(this)" >
