<?php session_start ();
require_once "../core/fidelite.php";
		  ...
		  <div class="flex-w flex-tr">
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form name="f1" method="post" action="supprimerclient.php">
						...
						<button input type="submit" id="get" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer" value="supprimer">
					Supprimer
						</button>
					</form>
				</div>
...
<!--===============================================================================================-->
  ...
  <script>$(document).ready(function(){$('#get').hide();});</script>
...
<!--===============================================================================================-->
  ...
  integrity="sha256-BJeo0qm959uMBGb65z40ejJYGSgR7REI4+CW1fNKwOg="
  crossorigin="anonymous"></script>
  <script>$(document).ready(function(){$('#get').show();});</script>
