...
<body class="animsition">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="indexon.php" class="flex-c-m trans-04 p-lr-25">
							Mon compte
						</a>
	...
	<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="num" placeholder="numero" maxlength="4" onblur="verifCin1(this)" />
						...
						<div class="bor8 m-b-20 how-pos4-parent">
	<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="nom" placeholder="nom" onblur="verifnom(this)" />
							
						</div>
						<div class="bor8 m-b-20 how-pos4-parent">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="cinn" maxlength="8" placeholder="cin" onblur="verifCin(this)" value="<?php echo $cin ; ?>" readonly>
