      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Hadouej Sonia</span>
                <img class="img-profile rounded-circle" src="sousou.jpg">
              </a>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="categ1.html" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><em class="fas fa-plus-circle"></em> Ajouter une Catégorie</a></div>
          <!-- Content Row -->
          <div class="row">
