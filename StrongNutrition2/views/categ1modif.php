...
<i class="fas fa-shipping-fast"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Modification de la Catégorie</h1>
          </div>
          <!-- Content Row -->
          <!-- Content Row -->
          <div class="row">
      ...
      <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><em class="fas fa-cogs"> Modifier un produit selon sa catégorie</em></h6>
...
<tr>
  ...
  <th> <br><br><br><td><i class="fas fa-pen"> </i><input href="categ.php" type="submit" value="Valider la modification" name="modifier1" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" onClick="verifForm(this)" ><a href="categ.php"></th>
      ...
      <span class="d-sm-flex align-items-center justify-content-between mb-4"></span> <a href="categ.php">
<i class="fas fa-arrow-circle-left" ></i></a><!-- End of Main Content -->
