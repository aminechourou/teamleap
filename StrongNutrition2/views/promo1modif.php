    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Modification du Produit</h1>
          <!-- DataTales Example -->
...
<div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><em class="fas fa-cogs"> Modifier un Produit éxistant</em></h6>
...
<tr>
 ...
 <th>
					...
					<option value="c1">Disponible</option>
				    <option value="c1">Non disponible</option>
				    <option value="c1">Prochainement</option>
					</select>
					  </th></tr>
