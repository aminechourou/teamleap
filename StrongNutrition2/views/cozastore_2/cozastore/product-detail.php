...
<<<<<<< HEAD:StrongNutr/views/productPack.php
						<?php session_start ();  
...
=======
							<?php session_start ();
>>>>>>> 172a2617f46f7b5f7705b61d939e6921c6ccb68a:StrongNutrition2/views/cozastore_2/cozastore/product-detail.php
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
							  <div class="item-slick3" data-thumb="..\<?php echo $row['imageprod'] ;?>">
									<div class="wrap-pic-w pos-relative">
										<img src="..\<?php echo $row['imageprod'] ;?>" alt="IMG-PRODUCT">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail1.php?reference=<?PHP echo $row['reference']; ?>"" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									<?PHP echo $row['nom']; ?>
								</a>
                                  <span class="stext-105 cl3">
