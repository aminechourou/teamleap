						...
						<ul class="main-menu">
							...
							<li>
								...
								<ul class="sub-menu">
									...
									<li><a href="product 3.html">Compliments Alimentaires</a></li>
									<li><a href="product 2.html">Gainer</a></li>
									<li><a href="product 3.html">Protéine</a></li>
									<li><a href="product 3.html">Vitamines</a></li>
...
<td><?PHP echo $row['referenceprod']; ?></td>
<td><?PHP echo $row['categorieprod']; ?></td>
<td><?PHP echo $row['prixprod']; ?></td>
<td><?PHP echo $row['etatprod']; ?></td>
<td><?PHP echo $row['quantiteprod']; ?></td>
<td><img width="100" height="100" src=" <?php echo $row['imageprod'] ;?>" ></td>
