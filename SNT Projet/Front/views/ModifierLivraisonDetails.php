...
<td><input type="date" name="dateL" value="<?PHP echo $dateL ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
...
<tr>
                            ...
                            <td>
                            <select  class="dis-none" name="cinClient" class="form-control form-control-user"  width="30%"  size="1"  onblur="verifSelection(this)" disabled>
...
<td>
                            <select  class="dis-none" name="idCommande" class="form-control form-control-user"  width="30%"  size="1"  onblur="verifSelection(this)" disabled>
